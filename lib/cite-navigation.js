...
var CiteNavigation = function (_React$Component) {
  ...
  _createClass(CiteNavigation, [{
    key: '_immutableItems',
    value: function _immutableItems() {
      return new _immutable2.default.fromJS(this.state.props);
    }
  }, {
    key: 'active_index',
    ...
    value: function render() {
      var _props = this.props,
          ...
          getActiveItemIndex = _props.getActiveItemIndex;
      ...
      return _react2.default.createElement(
        ...
        items.map(function (item, i) {
          return _react2.default.createElement(_citeNavigationItem2.default, { text: item.text,
            key: i,
