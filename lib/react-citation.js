...
var _activeItem = require('./active-item');

var _activeItem2 = _interopRequireDefault(_activeItem);
...
var ReactCitation = function (_React$Component) {
  ...
  function ReactCitation(props) {
    ...
    return _possibleConstructorReturn(this, (ReactCitation.__proto__ || Object.getPrototypeOf(ReactCitation)).call(this, props));
  }
...
exports.default = (0, _activeItem2.default)(ReactCitation);